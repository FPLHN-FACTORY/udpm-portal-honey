...
import ModalImportExcelLabReport from "./ModalImportExcelLabReport";
import ModalConfirmLabReport from "./ModalConfirmLabReport";
...
export default function ProjectManager() {
  ...
  const columsPreview = [
    ...
    {
      title: "Số lượng mật ong",
      dataIndex: "numberHoney",
      key: "numberHoney",
      render: (_, record) => {
        return record.numberHoney === null ? (
          <span style={{ color: "orange" }}>không có dữ liệu</span>
        ) : (
          <span>{record.numberHoney}</span>
        );
      },
    },
    {
