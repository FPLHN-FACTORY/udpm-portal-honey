...
public class ExcelUtils {
    ...
    public static boolean checkNullCell(Cell obj) {
        ...
        switch (obj.getCellTypeEnum()) {
            case STRING:
                ...
                String objStr = DataUtils.safeToString(cellValue);
        ...
        if (DataUtils.isNullObject(cellValue) || "Null".equalsIgnoreCase(DataUtils.safeToString(cellValue))) {
            return true;
        }
        return false;
    }
    ...
    public static Object getValueOfCell(Cell cell) {
        if (DataUtils.isNullObject(cell)) {
            return null;
        }
    ...
    public static String getCellString(Cell cell) {
        ...
        switch (cell.getCellTypeEnum()) {
            case NUMERIC:
                double dataCell = cell.getNumericCellValue();
                return DataUtils.safeToString(new Double(dataCell).intValue());
            case STRING:
                return cell.getStringCellValue();
            default:
                return null;
    ...
    public static Double getCellDouble(Cell cell) {
        ...
        switch (cell.getCellTypeEnum()) {
            ...
            case STRING:
                return DataUtils.parseToDouble(cell.getStringCellValue());
            default:
                return null;
        }
    }
    ...
    public static Long getCellLong(Cell cell) {
        ...
        switch (cell.getCellTypeEnum()) {
            case NUMERIC:
                ...
                return (new Double(dataCell)).longValue();
            case STRING:
                return DataUtils.parseToLong(cell.getStringCellValue());
            default:
                return null;
        }
    }
